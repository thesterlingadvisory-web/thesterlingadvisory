    ...
    services: [
      {
        ...
        documents: ['PAN Card of Proprietor', 'Aadhaar Card', 'Bank Statement', 'Office Address Proof (Utility Bill)', 'NOC from Owner (if rented)'],
      ...
      },
      {
        ...
        documents: ['PAN & Aadhaar of Designated Partners', 'Passport size photos', 'Office Address Proof (NOC & Utility Bill < 2 months old)', 'Digital Signature Certificate (DSC)'],
      ...
      },
      {
        ...
        documents: ['PAN & Aadhaar of Directors', 'Passport/Voter ID (Identity Proof)', 'Bank Statement (Address Proof)', 'Utility Bill for Regd Office (< 2 months old)', 'NOC from Owner'],
